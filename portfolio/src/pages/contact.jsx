        ...
        <div className="left-contact-div">
          <div className="left-image-div">
            ...
            <div className="left-image-text-1">
              "Every design decision I make is focused on enhancing usability,
              improving accessibility, and ensuring that the user’s experience
          ...
          <div className="form-div">
            <form action="">
              ...
              <div className="mb-3 input-div-message input-div-submit">
                <button type="button" className="btn btn-light submit-btn">
                  Submit
                </button>
              </div>
            </form>
